        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-8 ">
            <div className="flex flex-col md:flex-row items-center mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-10 text-sm">
                  現在大阪にて秋と冬の匂いが好き<br />
                  2019年より飲食を始める。<br />
                  島根・鳥取・広島・香川・岡山・大阪・京都を経て現在大阪<br />
                  2025年よりと書いていいですか！そこのあなた！！<br />
                  <br />
                  CODで大会とかでてたりして優勝とかしてたり<br />
                  FPS好きな人一緒にゲームしましょ。。。<br />
                  キャリーできます！！
                </p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-8 text-gray-600 mt-30">
              <div>
                <h3 className="text-xl font-semibold text-gray-600 mb-4">勉強中</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-600 mb-4">趣味</h3>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-gray-500 rounded-full mr-3"></span>
